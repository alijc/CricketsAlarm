...
public class AlarmCancelDialog extends Activity {
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (CricketsAlarm.ALARM_TERMINATED.equals(intent.getAction()) && mAppWidgetId == appWidgetId) {
                finish();
            }
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAppWidgetId = CricketsAlarmWidget.getAppWidgetId(getIntent());
        ...
        IntentFilter filter = new IntentFilter(CricketsAlarm.ALARM_TERMINATED);
        registerReceiver(mReceiver, filter);

        // Handler to the lock object
        KeyguardManager km = (KeyguardManager) getSystemService(KEYGUARD_SERVICE);
        mKeyguardLock = km.newKeyguardLock(CricketsAlarm.TAG);

        // Handler to the power manager, to turn the screen on
        PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
        mWakeLock = pm.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, CricketsAlarm.TAG);
    ...
    private void snoozeAlarm(Context context) {
        ...
        snooze.setAction(CricketsAlarm.ACTION_SNOOZE_ALARM);
    ...
    private void dismissAlarm(Context context) {
        ...
        dismiss.setAction(CricketsAlarm.ACTION_CANCEL_ALARM);
